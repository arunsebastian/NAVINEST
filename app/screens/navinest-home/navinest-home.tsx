        ...
        for (let i = 0; i < 120; i++) {
            if (i % 12 === 1) {
                items.push({
                    ...
                    name: 'John Doe',
                    username: '@johndoe',
                    tweet: 'The quick brown fox jumps over the lazy dog. The quick brown fox jumps over the lazy dog.',
                ...
                items.push({
                    ...
                    name: 'John Doe',
                    username: '@johndoe',
                    tweet: 'The quick brown fox jumps over the lazy dog. The quick brown fox jumps over the lazy dog. The quick brown fox jumps over the lazy dog',
                    widthRatio: 6,
                    heightRatio: 3,
                    id: ++idCounter.current
                });
